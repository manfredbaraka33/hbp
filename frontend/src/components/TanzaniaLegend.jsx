...
const TanzaniaLegend = () => {
  return (
    <div 
      ...
      style={{ position: 'absolute', bottom: '30px', right: '30px', zIndex: 1000, width: '20%', height:"45%", fontSize: '14px', fontWeight: '600' }}
    >
      <h5 style={{ marginBottom: '10px' }}>Patients</h5>
      {grades.map((grade, index) => {
        const nextGrade = grades[index + 1];
        const color = colors[index];
        return (
          <div key={grade} style={{ display: 'flex', alignItems: 'center', marginBottom: '6px' }}>
            <div
              style={{
