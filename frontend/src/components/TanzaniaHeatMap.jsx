...
const TanzaniaHeatMap = ({ data }) => {
  ...
  const regionCounts = useMemo(() => {
    ...
    // console.log('Region counts computed:', counts);
    return counts;
  }, [data]);
  ...
  return (
    <div style={{ height: '600px', width: '100%', backgroundColor: '#fff' }} className="p-5 rounded container">
      <h3 className='text-dark'>Patient Distribution Across Tanzania</h3>
      <MapContainer
        style={{ height: '100%', width: '100%' }}
        zoom={6}
        center={[-6.369028, 34.888822]} // Approx center of TZ
        zoomControl={true}
...
export default TanzaniaHeatMap;
